...
const Footer = () => {
  return (
   <footer className="bg-secondary text-white py-16 px-6 md:px-12 mt-10 rounded-3xl shadow-2xl">
  <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-10">
    ...
    <div className="md:col-span-2">
      ...
      <div className="flex gap-4 mt-6">
        ...
        <a
          href="#"
          className="w-10 h-10 flex items-center justify-center rounded-full border border-white/60 hover:bg-white hover:text-black transition duration-300"
        >
    ...
    <div>
      ...
      <ul className="space-y-3 text-sm">
        ...
        <li><a href="#coverage" className="hover:text-primary transition">Coverage Area</a></li>
    ...
    <div>
      ...
      <ul className="space-y-3 text-sm">
        ...
        <li><a href="#mission" className="hover:text-primary transition">Our Mission</a></li>
